  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          elevation: 2,
          title: Center(child: Text('Agri Wagon' , style: TextStyle(color: Colors.white),)),
          actions : <Widget>[
            GestureDetector(
              onTap: (){
              },
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    {
                      Fluttertoast.showToast(msg: "Minimum order value is 400 /-" , textColor: Colors.white , backgroundColor: Colors.black);
                    }
